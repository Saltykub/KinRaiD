...
const Question = (props) => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center sm:flex-row sm:items-center sm:space-x-8">
            ...
            <motion.button onClick={handleYes} whileHover={{scale : 1.1}}
            ...
            <motion.button onClick={handleNo} whileHover={{scale : 1.1}}
            ...
            <motion.button onClick={handleMaybe} whileHover={{scale : 1.1}}
